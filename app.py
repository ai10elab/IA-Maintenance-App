...
if api_key:
    ...
    st.markdown("### 📡 Connexion au serveur Google...")
    available_models = []
    
    try:
        # Le scanner qui marche sur ton Mac
    ...
    if available_models:
        selected_model = st.selectbox("Sélectionnez le moteur IA qui fonctionne pour vous :", available_models)
            ...
            if uploaded_pdf and st.button("🚀 Analyser le manuel"):
                with st.spinner("Lecture et préparation de l'export Excel..."):
                    ...
                    try:
                        ...
                        # On retire le bloc CSV brut de l'écran pour que ce soit joli
                        ...
                        # Création sécurisée du fichier Excel en arrière-plan
                        ...
                        if csv_match:
                            ...
                            try:
                                ...
                                pass # Si le CSV est mal formaté, ça ne plante pas l'application
                    except Exception as e:
